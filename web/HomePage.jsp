<%-- 
    Document   : HomePage
    Created on : 10-Jan-2018, 14:58:25
    Author     : Stephen
--%>
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <c:if test="${currentAgent.getRole().equals('admin')}">
          
          
      
      
            <a href="BuildAdminReportServlet" class="w3-bar-item w3-button">View Report</a>
      ...
      <shiro:user>
            ...
            <a href="ViewPropertiesServlet" class="w3-bar-item w3-button">Manage Properties</a>
            
            <a href="./agent/updateDetails.jsp" class="w3-bar-item w3-button">My Account</a>
          
            <a href="logoutServlet" class="w3-bar-item w3-button">Logout</a>
            
            <img src="/LitRealty/agent/agentImages/${currentAgent.getImage()}" class="user">
